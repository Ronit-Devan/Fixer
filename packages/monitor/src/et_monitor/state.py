    ...
    def tick(self, dt: float | None = None) -> Snapshot:
        ...
        for gr in readings:
            ...
            snap = Snapshot(
                ...
                prompt_tokens_total=lm.prompt_tokens_total if lm else None,
                predicted_tokens_total=lm.predicted_tokens_total if lm else None,
                prompt_seconds_total=lm.prompt_seconds_total if lm else None,
                predicted_seconds_total=lm.predicted_seconds_total if lm else None,
...
def _snap_to_dict(s: Snapshot) -> dict:
    return {
        ...
        "predicted_tokens_total": s.predicted_tokens_total,
        "prompt_seconds_total": s.prompt_seconds_total,
        "predicted_seconds_total": s.predicted_seconds_total,
        "ttft_s": s.ttft_s,
        "ctx_size": s.ctx_size,
